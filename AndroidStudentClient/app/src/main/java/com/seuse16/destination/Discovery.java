...
public class Discovery extends Fragment implements ViewPager.OnPageChangeListener,View.OnClickListener{
    ...
    private void initView(){
        ...
        bt4=view.findViewById(R.id.frag4);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.frag1:
                ...
                break;
            case R.id.frag2:
                bt2.setBackgroundColor(Color.parseColor("#92D050"));
                viewPager.setCurrentItem(1);
                break;
            case R.id.frag3:
                bt3.setBackgroundColor(Color.parseColor("#92D050"));
                viewPager.setCurrentItem(2);
                break;
            case R.id.frag4:
                bt4.setBackgroundColor(Color.parseColor("#92D050"));
    ...
    private void initBtnListener(){
        ...
        bt4.setBackgroundResource(R.color.White);
    }
}
